...
inoremap [ []<Left>
inoremap __ def __init__(self,):<Left><Left>
inoremap df def (self):<Left><Left><Left><Left><Left><Left><Left>
inoremap pf print(f"")<Left><Left>
inoremap pt print("")<Left><Left>
inoremap sf self.
inoremap { {}<Left>
let &cpo=s:cpo_save
unlet s:cpo_save
...
83
normal! zo
let s:l = 99 - ((14 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
99
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 21 - ((18 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
21
...
tabnext 1
badd +131 pkg/ui.py
badd +0 pkg/settings/maze.py
badd +24 pkg/sprites/hero.py
badd +0 pkg/settings/config.py
badd +0 pkg/sprites/items.py
